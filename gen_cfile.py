...
def GenerateFileContent(Node, headerfilepath, pointers_dict = {}):
    ...
    obj_name_prefix = Node.GetNodeName()+"OD_" # OD means Object Dictionary
...
#-------------------------------------------------------------------------------
    ...
    texts["file_include_name"] = "__"+headerfilepath.replace(".", "_").upper()+"__"
...
"""%texts
    ...
    if texts["iam_a_slave"]:
        HeaderFileContent += """
/* Slave node data struct, OD means Object Dictionary */
extern CO_Data %(NodeName)s_ObjDictData;
"""%texts
    else:
        HeaderFileContent += """
/* Master node data struct, OD means Object Dictionary */
extern CO_Data %(NodeName)s_ObjDictData;
"""%texts
